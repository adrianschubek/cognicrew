...
DROP FUNCTION IF EXISTS public.get_user_global_rank(project_id_param bigint);
...
--
-- Name: get_user_global_rank(bigint); Type: FUNCTION; Schema: public; Owner: supabase_admin
--

CREATE FUNCTION public.get_user_global_rank(project_id_param bigint) RETURNS TABLE(user_id uuid, user_rank integer)
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
...
ALTER FUNCTION public.get_user_global_rank(project_id_param bigint) OWNER TO supabase_admin;
...
COMMENT ON COLUMN public.profiles.user_tags IS 'List of tags associated with the user that represent his interests.';
...
--
-- Name: FUNCTION get_user_global_rank(project_id_param bigint); Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON FUNCTION public.get_user_global_rank(project_id_param bigint) TO postgres;
GRANT ALL ON FUNCTION public.get_user_global_rank(project_id_param bigint) TO anon;
GRANT ALL ON FUNCTION public.get_user_global_rank(project_id_param bigint) TO authenticated;
GRANT ALL ON FUNCTION public.get_user_global_rank(project_id_param bigint) TO service_role;
...
GRANT ALL ON FUNCTION public.transfer_project(p_owner_name text, p_project_id bigint) TO anon;
