...
import { useAchievementsByUser, useNotAchievementsByUser } from "../../utils/hooks";
...
export default function Achievement() {
  ...
  return (
    ...
    {notAchievements && notAchievements.map((achievement, index) => (
      <React.Fragment key={achievement.id}>
        <List.Item style={styles.notAchieved}
          title={achievement.name}
          titleStyle={styles.title}
          description={achievement.description}
          left={() => (
